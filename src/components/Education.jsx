...
const Education = () => (
  <div style={{ background: '#0A0A0A', minHeight: '100vh', position: 'relative' }}>
    <SparklesBackground count={18} color1="#3B82F6" color2="#60A5FA" style={{ opacity: 0.3 }}/>
      ...
      <div style={{ position: 'relative' }}>
        ...
        {education.map((edu, i) => (
          <motion.div key={edu.id}
            ...
            style={{ position: 'relative', paddingLeft: 'clamp(2rem, 5vw, 3rem)', marginBottom: '2.5rem' }}
          >
            ...
            >
              ...
              <h3 style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(0.95rem, 2vw, 1.05rem)', fontWeight: 700, color: '#FFFFFF', marginBottom: '0.25rem' }}>{edu.degree}</h3>
              <h4 style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(0.82rem, 1.8vw, 0.9rem)', fontWeight: 600, color: '#3B82F6', marginBottom: '0.75rem' }}>{edu.institution}</h4>
              ...
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(0.82rem, 1.5vw, 0.85rem)', color: '#525252', lineHeight: 1.65 }}>
