...
/* Simple mailto — avoid heavy encoding that some mail clients reject */
const EMAIL_HREF    = 'mailto:mitenshah24@gmail.com';
const WHATSAPP_HREF = 'https://wa.me/917874393172?text=Hii%20Miten%2C%20I%20came%20across%20your%20portfolio%20and%20would%20like%20to%20connect%20with%20you%20regarding%20...';
...
const Contact = () => (
  <div style={{ background: '#0A0A0A', minHeight: '100vh', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '5rem 2rem 4rem' }}>
    <SparklesBackground count={24} color1="#3B82F6" color2="#60A5FA" style={{ opacity: 0.4 }}/>
    ...
    <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '900px' }}>
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(2.2rem, 5vw, 4rem)', fontWeight: 900, color: '#FFFFFF', lineHeight: 1.1, marginBottom: '0.75rem' }}>
          Let's <span style={{ color: '#60A5FA' }}>Connect.</span>
        </h2>
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.9rem', color: '#525252' }}>
          Available for project/product roles, consulting, and collaboration.
        </p>
      </motion.div>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: '200px' }}>
          <h3 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', fontWeight: 900, color: '#FFFFFF', marginBottom: '0.3rem', lineHeight: 1.1 }}>
            Miten Shah
          </h3>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
            {[
              { icon: <Mail size={14}/>,        label: 'mitenshah24@gmail.com',         href: EMAIL_HREF },
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.6 }}
        ...
        <motion.a data-hover href={EMAIL_HREF}
          ...
          <Mail size={16}/> Connect via Email
        </motion.a>
